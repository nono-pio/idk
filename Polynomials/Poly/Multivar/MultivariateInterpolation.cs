...
public static class MultivariateInterpolation
{
    ...
    public sealed class InterpolationZp64
    {
        ...
        private readonly List<long> points = new List<long>();
        ...
        public InterpolationZp64(int variable, long point, MultivariatePolynomialZp64 value)
        {
            ...
            this.lins = value.CreateOne();
            this.poly = value.Clone();
            this.ring = (IntegersZp64)poly.ring;
            points.Add(point);
            values.Add(value);
            mixedRadix.Add(value.Clone());
        }
        ...
        public InterpolationZp64(int variable, PolynomialRing<MultivariatePolynomialZp64> factory) : this(variable,
            factory.Factory())
        {
        }
