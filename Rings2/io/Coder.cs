...
namespace Cc.Redberry.Rings.Io
{
    ...
    public class Coder<Element, Term, Poly> : IParser<Element>, IStringifier<Element>, Serializable
    {
        // parser stuff
        /// <summary>
        /// the base ring
        ...
        /// inner coders
        /// </summary>
        protected readonly Map<Ring<?>, Coder<?, ?, ?>> subcoders;
        // parser stuff
        /// <summary>
        /// the base ring
        /// </summary>
        ...
        /// </summary>
        public virtual Coder<Element, Term, Poly> WithEncoder(Coder<?, ?, ?> subencoder)
        {
        ...
        /// </summary>
        public virtual Coder<Oth, ?, ?> Map<Oth>(Ring<Oth> ring, Function<Element, Oth> func)
        {
