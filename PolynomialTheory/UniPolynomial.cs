...
public class UniPolynomial<T> where T : IEquatable<T>
{
    ...
    public static (UniPolynomial<T> Quotient, UniPolynomial<T> Remainder) Divide(IRing<T> ring, UniPolynomial<T> dividend, UniPolynomial<T> divisor)
    {
        ...
        while (dividendCopy.Count >= divisor.Coefficients.Length)
        {
            ...
            for (int i = 0; i <= divisor.Degree; i++)
            {
                ...
                dividendCopy[index] = ring.Subtract(dividendCopy[index], ring.Multiply(leadingQuotient, divisor.Coefficients[i]));
            }
    ...
    public static (UniPolynomial<T> Quotient, UniPolynomial<T> Remainder) PseudoDivide(IRing<T> ring, UniPolynomial<T> dividend, UniPolynomial<T> divisor)
    {
    ...
    public static (UniPolynomial<T>, UniPolynomial<T>, UniPolynomial<T>) ExtendedEuclidean(IRing<T> ring, UniPolynomial<T> a,
        UniPolynomial<T> b)
    {
        var a1 = One(ring);
        var a2 = Zero(ring);
    ...
    public static (UniPolynomial<T>, UniPolynomial<T>, UniPolynomial<T>) ExtendedPseudoEuclidean(IRing<T> ring, UniPolynomial<T> a,
        UniPolynomial<T> b)
    {
        var a1 = One(ring);
        var a2 = Zero(ring);
    ...
    public static UniPolynomial<T> operator /(UniPolynomial<T> a, T b) => new UniPolynomial<T>(a.Ring, a.Coefficients.Select(c => a.Ring.Divide(c, b)).ToArray());
    ...
    public static UniPolynomial<T> operator *(UniPolynomial<T> a, UniPolynomial<T> b)
    {
        ...
        for (int i = 0; i <= a.Degree; i++)
        {
            ...
            {
                coefficients[i + j] = ring.Add(coefficients[i + j], ring.Multiply(a.Coefficients[i], b.Coefficients[j]));
            }
        }
