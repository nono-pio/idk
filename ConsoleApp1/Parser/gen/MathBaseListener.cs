...
// Generated from C:/Users/nolan/RiderProjects/ConsoleApp1/ConsoleApp1/parser/Math.g4 by ANTLR 4.13.1
...
public partial class MathBaseListener : IMathListener {
	/// <summary>
	/// Enter a parse tree produced by <see cref="MathParser.prog"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterProg([NotNull] MathParser.ProgContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="MathParser.prog"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitProg([NotNull] MathParser.ProgContext context) { }
	/// <summary>
